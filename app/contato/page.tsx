...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Por exemplo, uma chamada para sua API
    ...
    <div className="bg-white py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          <h1 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Entre em Contato</h1>
          ...
          <div className="flex flex-col justify-between rounded-2xl bg-gray-50 p-8">
            <div>
              ...
              <p className="mt-4 text-base text-gray-600">
                Estamos sempre disponíveis para responder suas dúvidas e receber suas sugestões.
              </p>
            </div>
            ...
            <div className="mt-8 space-y-6">
              <div className="flex items-center gap-x-4">
                ...
                <span className="text-gray-600">estradeirandooficial@gmail.com</span>
              </div>
              <div className="flex items-center gap-x-4">
                <MapPinIcon className="h-6 w-6 text-gray-400" />
                <span className="text-gray-600">Carazinho, RS - Brasil</span>
              </div>
            </div>
            ...
            <div className="mt-8">
              ...
              <div className="mt-4 flex space-x-6">
                <a href="https://instagram.com/estradeirando" className="text-gray-400 hover:text-gray-500">
                ...
                <a href="https://www.facebook.com/profile.php?id=100083581413735" className="text-gray-400 hover:text-gray-500">
